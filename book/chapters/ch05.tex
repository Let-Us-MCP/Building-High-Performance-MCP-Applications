...
structurally wrong: unknown tool, malformed parameters, server on fire. Models are unlikely to recover from these, because the problem lies in the
shape of the request and the model can only vary its arguments.
