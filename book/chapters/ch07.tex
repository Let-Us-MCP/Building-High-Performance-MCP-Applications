...
\bookfig[0.96]{prompt-prefix}{A prompt is a conversation prefix. Return an
assistant turn and you have shown the model the answer shape instead of
describing it.}{prompt-prefix}
