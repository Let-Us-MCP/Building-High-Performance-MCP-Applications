...
The word ``agent'' does most of the damage in this topic. It sounds like a new
kind of component, which invites a new kind of architecture, which invites a
framework to manage the new kind of architecture.

There is no new component. An agent is a host that also happens to be a server,
and once you see that, most of the subject collapses into things you already
know from the previous three chapters. What is left over is bookkeeping, and the
bookkeeping is where the money gets lost.
