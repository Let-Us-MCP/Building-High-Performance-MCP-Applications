...
Hashes, for a reason: the content may be private, and retaining it turns your
audit log into a second copy of the data you were protecting. A hash plus a source plus a length is enough to prove that a
...
log. \secref{tamper-evident} is about making that true instead of asserting it.
...
\bookfig[1.0]{audit-chain}{Hash chaining makes tampering detectable.
Publishing the head is what makes it detectable by somebody other than the
attacker.}{audit-chain}
