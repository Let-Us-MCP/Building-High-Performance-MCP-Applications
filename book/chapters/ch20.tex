...
The filtering happens in \texttt{visible\_tools}, so an unauthorized tool is
\emph{invisible} rather than present-and-forbidden. The model never sees it,
...
trade. Make the choice deliberately rather than inheriting it.
...
\midrule
Tests                 & \multicolumn{2}{r}{134, all passing} \\
...
Every number is reproducible on your own machine, and every one of them came from
a technique in this book rather than from faster hardware.
