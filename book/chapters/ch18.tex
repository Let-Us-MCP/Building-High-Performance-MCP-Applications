...
that actually drain, alerts that fire before a user notices.
...
The dual-era bridge answers \texttt{ping} for exactly this reason. Treat that
as a compatibility shim with a shelf life.
\end{notebox}
...
\bookfig[0.94]{xkcd-thundering-herd}{The same 2,000 clients and the same
one-hour TTL, with and without jitter.}{thundering-herd}
