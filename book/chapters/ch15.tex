...
Meridian's 200 tests run in 2.3 seconds and use no model at all. The eval suite is separate, slower, and gates deploys.
...
\midrule
Unit and contract & 200 tests, no model & every commit \\
