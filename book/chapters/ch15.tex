...
Meridian's 186 tests run in 2.3 seconds and use no model at all. The eval suite is separate, slower, and gates deploys.
...
\midrule
Unit and contract & 186 tests, no model & every commit \\
