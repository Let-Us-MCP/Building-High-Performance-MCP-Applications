...
Meridian's 196 tests run in 2.3 seconds and use no model at all. The eval suite is separate, slower, and gates deploys.
...
\midrule
Unit and contract & 196 tests, no model & every commit \\
