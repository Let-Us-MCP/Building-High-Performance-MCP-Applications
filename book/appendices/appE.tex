...
\begin{center}
\texttt{https://github.com/Let-Us-MCP/Building-High-Performance-MCP-Applications}
\end{center}
...
meridian/
  ...
  tests/             208 tests across five files
...
\bottomrule
\end{tabularx}
\caption{208 tests, roughly four seconds, no model required.}
