...
been promised this for two years. The room was delighted. Then somebody in the
back asked how long it took, and the presenter said, cheerfully, ``about forty
seconds,'' and the room stayed delighted, and I sat there thinking: forty
seconds? For that? The four systems it called were all sub-hundred-millisecond
services. I had seen their dashboards. Ninety-nine percent of that forty
seconds went somewhere, and nobody in the room, including the person who built
it, could tell you where.

That is the state of the art. We have built a genuinely new kind of software,
and we are shipping it with roughly the diagnostic sophistication of a 1996 CGI
script. We know it works. We do not know why it is slow, what it costs, or
which of the eleven things we could change would matter. We guess. Then we
rewrite the server in a faster language and save three milliseconds off a forty
second task, and we feel good about it, because at least rewriting things in
faster languages is a problem we know how to have.

\bookfig[0.82]{xkcd-roundtrips}{The optimisation everybody does, and the one
that works. Chapter~\ref{ch:primer} explains why the gap is this large, and
Chapter~\ref{ch:optimizing} spends thirty pages exploiting it.}{preface-roundtrips}
...
and the last one. That is the first version of MCP that comes with a promise
about how it will break. It is not a promise that it will not break. It is
better than that. It is a promise that it will break \emph{slowly and in
...
be a complete implementation of \texttt{2026-07-28} in about two thousand lines
of Python, and every listing in this book is lifted from it. When
