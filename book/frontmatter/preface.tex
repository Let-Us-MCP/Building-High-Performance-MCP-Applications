...
The title is a deliberate echo, and I want to be straightforward about that
rather than coy. \emph{Building High-Performance MCP Applications} is
\emph{High Performance Browser Networking} pointed at a different layer, and the
structure is borrowed on purpose: motivate with a measurement, define the terms
properly before spending them, build the mechanism, then say what it costs. If
that book taught you why your first byte arrives when it arrives, this one
should teach you why your agent's first token does.
