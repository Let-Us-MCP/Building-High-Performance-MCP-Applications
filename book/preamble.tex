% ---------------------------------------------------------------------------
% Building Awesome MCP Apps - preamble
...
% ---------------------------------------------------------------------------
% Epigraph. Every chapter opens with one, per house style.
% ---------------------------------------------------------------------------
\newcommand{\epigraph}[2]{%
  \begingroup
  \setlength{\leftskip}{0.20\textwidth}%
  \noindent\itshape\small\color{ink}#1\par
  \vspace{4pt}%
...
\newcommand{\keyidea}[1]{%
  \par\vspace{8pt}
  \noindent\begin{tcolorbox}[enhanced, breakable, colback=accentsoft,
...
\hypersetup{
  ...
  pdftitle={Building Awesome MCP Apps},
  pdfauthor={Krimler},
